...
namespace MyPortfolio.WebApi.Migrations
{
    ...
    [Migration("20250206124051_mig55")]
    partial class mig55
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.Identity.Role", b =>
                {
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.Identity.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("MyPortfolio.WebApi.Entites.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyPortfolio.WebApi.Entites.Identity.User", null)
                        .WithMany()
