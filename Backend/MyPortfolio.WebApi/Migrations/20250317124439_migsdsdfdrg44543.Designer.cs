...
namespace MyPortfolio.WebApi.Migrations
{
    ...
    [Migration("20250317124439_migsdsdfdrg44543")]
    partial class migsdsdfdrg44543
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogCategoryPortfolioBlog", b =>
                {
                    b.Property<int>("BlogCategoriesBlogCategoryId")
                        .HasColumnType("int");

                    b.Property<int>("PortfolioBlogsPortfolioBlogId")
                        .HasColumnType("int");

                    b.HasKey("BlogCategoriesBlogCategoryId", "PortfolioBlogsPortfolioBlogId");

                    b.HasIndex("PortfolioBlogsPortfolioBlogId");

                    b.ToTable("BlogCategoryPortfolioBlog");
                });
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.Notification", b =>
                {
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.PortfolioRoutingFooter", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PortfolioRoutingFooterId"));

                    b.Property<string>("pageHref")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.PortfolioTagPortfolioBlog", b =>
                {
                    b.Property<int>("PortfolioBlogId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PortfolioTagPortfolioBlog");
                });
            ...
            modelBuilder.Entity("BlogCategoryPortfolioBlog", b =>
                {
                    b.HasOne("MyPortfolio.WebApi.Entites.BlogCategory", null)
                        .WithMany()
                        .HasForeignKey("BlogCategoriesBlogCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyPortfolio.WebApi.Entites.PortfolioBlog", null)
                        .WithMany()
                        .HasForeignKey("PortfolioBlogsPortfolioBlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.PortfolioTagPortfolioBlog", b =>
                {
                    b.HasOne("MyPortfolio.WebApi.Entites.PortfolioBlog", "PortfolioBlogs")
                        .WithMany("PortfolioTagPortfolioBlogs")
                        .HasForeignKey("PortfolioBlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyPortfolio.WebApi.Entites.PortfolioBlogTag", "PortfolioBlogTags")
                        .WithMany("PortfolioTagPortfolioBlogs")
                        .HasForeignKey("PortfolioBlogTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PortfolioBlogTags");
            ...
            modelBuilder.Entity("MyPortfolio.WebApi.Entites.PortfolioBlog", b =>
                {
                    b.Navigation("PortfolioTagPortfolioBlogs");
                });
